...
def make_df_MS (excel_file_path, sheet_name, range_to_read, lines_to_read):
    ...
    df_qualityclass = pd.read_excel(excel_file_path, sheet_name = sheet_name, usecols=range_to_read, skiprows=5 + lines_to_read , nrows=12)
...
excel_file_path_properties = "Input_Excel/QC_Tablle.xlsx"
...
amount_products = 39
# bei mehr Produkte muss die Anzahl angepasst werden!
products_dict = {}
...
for i in range (amount_products):
    ...
    lines_to_read = i*17 # i= amount_products, 17 Zeilen pro Produkt werden gelesen
